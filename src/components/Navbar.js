...
export default function Navbar() {
  ...
  // Handle mobile menu item click with better UX
    ...
    <>
      <motion.header
        ...
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
          scrolled
            ? "bg-white/98 backdrop-blur-xl shadow-2xl border-b border-gray-100/50 py-0 sm:py-2"
                  ...
                  <div className="relative w-4 h-4">
                    <motion.span
                      ...
                      style={{
                        ...
                        left: "0",
                        background: isOpen
                          ? "linear-gradient(45deg, #1a7be6, #f35e0e)"
                          : "#374151",
                      }}
                      animate={
                        isOpen
                ...
                <div className="space-y-1">
                  {navLinks.map((link, index) => (
                    ...
                    >
                      <button
                        onClick={() =>
                          handleMobileNavClick(link.href.substring(1))
                        }
