...
export default function ContactLocation() {
  ...
  return (
    <section id="contact" className="relative py-20 md:py-32 overflow-hidden bg-gradient-to-br from-blue-50 via-white to-orange-50">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        >
          <svg width="100" height="100" viewBox="0 0 100 100" className="text-[#1a7be6]">
            <path d="M50 10L60 40L90 40L68 58L78 88L50 70L22 88L32 58L10 40L40 40Z" fill="currentColor" opacity="0.6"/>
        ...
        >
          <svg width="80" height="80" viewBox="0 0 80 80" className="text-[#f35e0e]">
            <polygon points="40,10 60,30 60,50 40,70 20,50 20,30" fill="currentColor" opacity="0.5"/>
        ...
        >
          <svg width="128" height="128" viewBox="0 0 128 128">
            <path d="M64 16 L112 64 L64 112 L16 64 Z" fill="none" stroke="#1a7be6" strokeWidth="2" opacity="0.6"/>
          </svg>
        </motion.div>
      </div>
      ...
      <div className="relative container mx-auto px-4">
        ...
        >
          ...
          >
            Siap mewujudkan event impian Anda? Hubungi kami sekarang untuk konsultasi dan dapatkan penawaran terbaik!
          </motion.p>
        </motion.div>
                      ...
                      >
                        {isSubmitting ? (
                          <div className="flex items-center justify-center gap-3">
                            ...
                            <span className="text-lg">Mengirim...</span>
                          </div>
                        ) : (
                          <span className="flex items-center justify-center gap-3">
                            ...
                            <span className="text-lg">Kirim Pesan</span>
                          </span>
                        )}
                      </motion.button>
                      ...
                      <AnimatePresence>
                        {submitStatus === 'success' && (
                          <motion.div
                            ...
                            className="flex items-center gap-3 p-5 backdrop-blur-sm bg-green-100/80 border border-green-200/60 text-green-800 rounded-2xl shadow-lg"
                          >
                            <motion.svg 
                              className="w-6 h-6" 
                              fill="none" 
                            ...
                            <span className="font-semibold">Pesan berhasil dikirim! Kami akan menghubungi Anda segera.</span>
                          </motion.div>
                        )}
                      </AnimatePresence>
                    </form>
                ...
                >
                  {contactInfo.map((info, index) => (
                    ...
                    >
                      ...
                      {/* Animated Border */}
                      <motion.div
                        className="absolute inset-0 rounded-3xl border-2 border-[#1a7be6]/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                      />
                    </motion.div>
                  ))}
                </motion.div>
                  ...
                  <div className="relative backdrop-blur-xl bg-white/40 border border-white/60 rounded-3xl p-8 shadow-2xl">
                    ...
                    <div className="space-y-6">
                      ...
                      >
                        ...
                        <div>
                          <p className="font-bold text-gray-900 text-lg">Alamat Lengkap:</p>
                          <p className="text-gray-700 leading-relaxed">
                            Jl. Jenderal Sudirman No. 123<br/>
                            Gedung FWB+ Tower, Lantai 15<br/>
                            Jakarta Pusat 10270
                          </p>
                        </div>
                      </motion.div>
                      ...
                      >
                        ...
                        <div>
                          <p className="font-bold text-gray-900 text-lg">Jam Buka:</p>
                          <p className="text-gray-700">Senin - Sabtu: 09:00 - 18:00</p>
                        </div>
                      </motion.div>
                      ...
                      >
                        <div className="flex-shrink-0 w-8 h-8 bg-[#1a7be6] text-white rounded-xl flex items-center justify-center">
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
                          </svg>
                        </div>
                        <div>
                          <p className="font-bold text-gray-900 text-lg">Akses:</p>
                          <p className="text-gray-700">Dekat stasiun MRT Bundaran HI</p>
                        </div>
                      </motion.div>
                    </div>
                  </div>
