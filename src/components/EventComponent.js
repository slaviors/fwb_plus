...
export default function EventComponent() {
  ...
  const getStatusBadge = (status) => {
    const badges = {
      planned:
        "bg-gradient-to-r from-blue-50 to-blue-100 text-[#1a7be6] border-[#1a7be6]/30 shadow-sm",
      ongoing:
        "bg-gradient-to-r from-green-50 to-green-100 text-green-700 border-green-300 shadow-sm",
      ended:
        "bg-gradient-to-r from-gray-50 to-gray-100 text-gray-600 border-gray-300 shadow-sm",
    };
      ...
      ongoing: (
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1m4 0h1m-6 4h6"
          />
        </svg>
      ),
      ended: (
      ...
      days.push(
        <motion.button
          ...
          className={`
                        ...
                        ${
                          isToday
                            ? "bg-gradient-to-br from-[#1a7be6] to-[#1a7be6]/80 text-white  border-2 border-[#1a7be6]/30"
                            : ""
                        }
                        ${
                          isSelected && !isToday
                            ? "bg-gradient-to-br from-[#f35e0e] to-[#f35e0e]/80 text-white  border-2 border-[#f35e0e]/30"
                            : ""
                        }
                        ${
                          !isSelected && !isToday
                        ...
                        ${
                          eventOnThisDay && !isSelected && !isToday
                            ? "bg-gradient-to-br from-orange-50 to-orange-100 border border-[#f35e0e]/20 text-[#f35e0e] font-bold"
                            : ""
                        }
                    `}
      ...
      >
        ...
        <div className="relative rounded-[22px] bg-white/90 backdrop-blur-lg border border-white/95 p-6 overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-6 p-4 rounded-xl bg-gradient-to-r from-blue-50/60 to-orange-50/40 border border-white/50 relative overflow-hidden">
            ...
            >
              {/* Button glow effect */}
              <motion.div className="absolute inset-0 rounded-xl bg-gradient-to-r from-orange-400/20 to-red-400/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              <motion.svg
                className="relative w-4 h-4"
                fill="none"
                stroke="currentColor"
          ...
          <div className="grid grid-cols-7 gap-1 mb-4">
            {dayNames.map((day) => (
              <div
                key={day.key}
                className="text-center py-2 text-xs font-medium text-gray-500 uppercase tracking-wider"
              >
                {day.label}
              </div>
            ))}
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(26,123,230,0.15) 0%, rgba(59,130,246,0.1) 35%, transparent 70%)",
          }}
          animate={{
            scale: [1, 1.1, 1],
            opacity: [0.3, 0.5, 0.3],
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(243,94,14,0.15) 0%, rgba(234,88,12,0.1) 35%, transparent 70%)",
          }}
          animate={{
            scale: [1, 1.15, 1],
            opacity: [0.2, 0.4, 0.2],
          ...
          <div className="relative z-10 py-8">
            ...
            >
              ...
              >
                ...
                <span className="relative z-10">Jadwal Event</span>
              </motion.span>
            </motion.div>
            ...
            >
              ...
              <p className="font-inter text-lg md:text-xl text-gray-600 leading-relaxed relative z-10 p-4">
                <motion.span
                  ...
                  style={{
                    background:
                      "linear-gradient(90deg, rgb(107,114,128), rgb(26,123,230), rgb(107,114,128))",
                    backgroundClip: "text",
                ...
                <motion.span
                  ...
                  style={{
                    background:
                      "linear-gradient(90deg, rgb(107,114,128), rgb(243,94,14), rgb(107,114,128))",
                    backgroundClip: "text",
                    WebkitBackgroundClip: "text",
                    color: "transparent",
                  }}
                >
                  {" "}
                  yang telah kami siapkan untuk Anda. Jelajahi kalender event
                  dan ‎
                </motion.span>
              ...
              >
                <div className="relative rounded-[22px] bg-white/90 backdrop-blur-lg border border-white/95 p-6">
                  <div className="flex items-center gap-3 mb-4 p-3 rounded-xl bg-gradient-to-r from-orange-50/60 to-blue-50/40">
                    ...
                    <div>
                      <h4 className="text-lg font-unbounded font-bold text-gray-800">
                        Events Hari Ini
                      </h4>
                  ...
                  <div className="space-y-3">
                    {selectedDateEvents.map((event, index) => (
                      ...
                      >
                        <h5 className="font-unbounded font-bold text-gray-900 mb-2">
                          {event.title}
                        </h5>
            ...
            <div className="relative rounded-[22px] bg-white/90 backdrop-blur-lg border border-white/95 p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 p-4 rounded-xl bg-gradient-to-r from-blue-50/60 to-orange-50/40">
                ...
                <motion.div
                  ...
                  whileHover={{ scale: 1.05 }}
                >
                  <div className="text-2xl font-unbounded font-bold text-[#f35e0e]">
                    {events.length}
                  </div>
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 rounded-2xl bg-gradient-to-br from-gray-50/80 to-white/60 backdrop-blur-sm border border-gray-200/50">
                            ...
                            >
                              ...
                              <div>
                                ...
                                <p className="text-sm font-inter font-semibold text-gray-900">
                                  {event.location || "Lokasi akan ditentukan"}
                                </p>
                              </div>
                            </motion.div>
                          </div>
                    ...
                    >
                      <div className="relative rounded-[22px] bg-white/90 backdrop-blur-lg border border-white/95 p-4 sm:p-12 text-center">
                        ...
                        <h3 className="text-2xl font-unbounded font-bold text-gray-900 mb-3">
                          Tidak Ada{" "}
                          <span className="text-[#1a7be6]">Event</span>
                        </h3>
                        <p className="text-gray-600 font-inter leading-relaxed">
                          Belum ada event yang terjadwal. Pantau terus halaman
                          ini untuk update event terbaru!
                        </p>
                      </div>
                    </motion.div>
                  )}
                  ...
                  >
                    <div className="relative rounded-[22px] bg-white/90 backdrop-blur-lg border border-white/95 p-6">
                      <div className="flex items-center gap-3 mb-5 p-3 rounded-xl bg-gradient-to-r from-orange-50/60 to-blue-50/40">
                        ...
                        <div>
                          <h4 className="text-base font-unbounded font-bold text-gray-800">
                            Events Hari Ini
                          </h4>
                          <p className="text-sm text-gray-600 font-inter">
                            {formatDate(selectedDate)}
                        ...
                        {selectedDateEvents.map((event, index) => (
                          ...
                          >
                            <div className="relative rounded-xl bg-white/70 backdrop-blur-sm p-4 border border-white/50">
                              <h5 className="font-unbounded font-bold text-gray-900 text-sm mb-2 group-hover:text-[#1a7be6] transition-colors">
                                {event.title}
                              </h5>
                  ...
                  <div className="flex items-center justify-between gap-4 mb-6 p-4 rounded-xl bg-gradient-to-r from-blue-50/60 to-orange-50/40">
                    <div>
                      ...
                      <p className="font-inter text-gray-600 leading-relaxed">
                        Jelajahi koleksi lengkap event kami. Klik tanggal di
                        kalender untuk melihat event spesifik pada hari
                        tersebut.
                      </p>
                    </div>
                      ...
                      {events.length > 0 ? (
                                ...
                                >
                                  <div className="flex items-center gap-2">
                                    <div className="p-1.5 rounded-lg bg-[#1a7be6]/10 border border-[#1a7be6]/20">
                                      <svg
                                        className="w-3.5 h-3.5 text-[#1a7be6]"
                                        fill="none"
                                        stroke="currentColor"
                                        viewBox="0 0 24 24"
                                      >
                                  ...
                                  <p className="text-xs font-inter font-semibold text-gray-900 leading-tight">
                                    {formatDateTime(event.startTime)}
                                  </p>
                                </motion.div>
                                ...
                                >
                                  <div className="flex items-center gap-2">
                                    <div className="p-1.5 rounded-lg bg-[#f35e0e]/10 border border-[#f35e0e]/20">
                                      <svg
                                        className="w-3.5 h-3.5 text-[#f35e0e]"
                                        fill="none"
                                        stroke="currentColor"
                                        viewBox="0 0 24 24"
                                      >
                        ...
                        >
                          <div className="relative rounded-[22px] bg-white/90 backdrop-blur-lg border border-white/95 p-12 text-center">
                            ...
                            <p className="text-gray-600 font-inter leading-relaxed">
                              Belum ada event yang terjadwal. Pantau terus
                              halaman ini untuk update event terbaru!
                            </p>
                          </div>
                        </motion.div>
                      )}
