...
export default function Footer() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const footerTop = footerSection
        ? footerSection.offsetTop
        : documentHeight;
  ...
  return (
    <footer className="relative bg-gradient-to-br from-white via-blue-50/50 to-orange-50/30 text-gray-800 overflow-hidden border-t border-gray-100">
      ...
      <motion.button
        ...
        className={`fixed lg:hidden scale-80 bottom-24 right-3 z-50 bg-gradient-to-r from-[#1a7be6] to-blue-600 p-4 rounded-full shadow-2xl hover:shadow-blue-500/30 transition-all duration-300 border border-blue-200 backdrop-blur-sm ${
      ...
      <motion.button
        ...
        className={`fixed scale-80 lg:scale-100 bottom-8 lg:right-8 right-1 z-50 bg-orange-600/80 hover:bg-orange-700/80 backdrop-blur-sm border text-white px-5 py-3 rounded-full shadow-lg flex items-center transition-all duration-200 ${
          isVisible ? "opacity-100" : "opacity-0 pointer-events-none"
        }`}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="py-12 sm:py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 md:gap-12 items-start">
            <motion.div
              className="md:col-span-2 lg:col-span-5 text-center md:text-left"
            ...
            >
              ...
              <p className="text-gray-600 text-sm sm:text-base mb-6 sm:mb-8 max-w-md mx-auto md:mx-0 leading-relaxed px-4 md:px-0">
                Professional event organizer yang menciptakan pengalaman tak
                terlupakan untuk setiap momen spesial Anda. Wujudkan acara
                impian bersama kami.
              </p>
              ...
              <div className="flex justify-center md:justify-start space-x-3 sm:space-x-4">
                {socialMedia.map((social, index) => (
                  <motion.a
                    ...
                    className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white shadow-md flex items-center justify-center text-gray-600 hover:bg-[#1a7be6] hover:text-white hover:shadow-lg transition-all duration-300 border border-gray-200 group"
            ...
            >
              <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-4 sm:mb-6 flex items-center justify-center md:justify-start">
                <span className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-[#1a7be6] flex items-center justify-center mr-2 sm:mr-3">
                  <svg
              ...
              <ul className="space-y-2 sm:space-y-3 px-4 md:px-0">
                {quickLinks.map((link, index) => (
                  ...
                  >
                    <motion.button
                      ...
                      className="text-gray-600 hover:text-[#1a7be6] transition-all duration-300 relative group text-sm sm:text-base font-medium inline-flex items-center w-full md:w-auto justify-center md:justify-start"
                      whileHover={{ x: 5 }}
                      transition={{ duration: 0.3 }}
                    >
                      <span className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-[#1a7be6] rounded-full mr-2 sm:mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                      {link.name}
                      <span className="absolute bottom-0 left-1/2 md:left-0 transform -translate-x-1/2 md:translate-x-0 w-0 h-0.5 bg-[#1a7be6] transition-all duration-300 group-hover:w-3/4 md:group-hover:w-full"></span>
                    </motion.button>
                  </motion.li>
                ))}
              </ul>
            ...
            >
              <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-4 sm:mb-6 flex items-center justify-center md:justify-start">
                <span className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-[#f35e0e] flex items-center justify-center mr-2 sm:mr-3">
                  <svg
                    className="w-3 h-3 sm:w-4 sm:h-4 text-white"
                    fill="none"
                    stroke="currentColor"
              ...
              <div className="space-y-3 sm:space-y-4 px-4 md:px-0">
                <motion.div
                  className="flex items-center justify-center md:justify-start group"
                  whileHover={{ x: 5 }}
                  transition={{ duration: 0.3 }}
                >
                  <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-[#f35e0e] flex items-center justify-center mr-2 sm:mr-3 flex-shrink-0">
                    <svg
                      className="w-3 h-3 sm:w-4 sm:h-4 text-white"
                      fill="none"
                      stroke="currentColor"
                ...
                >
                  ...
                  <a
                    href="mailto:fwbplus.eo@gmail.com"
                    className="text-gray-600 hover:text-[#f35e0e] transition-colors text-xs sm:text-sm break-all"
                  >
        ...
        <motion.div
          className="border-t border-gray-200 py-4 sm:py-6 backdrop-blur-sm"
          initial={{ opacity: 0 }}
        ...
        >
          <div className="flex flex-col md:flex-row justify-center items-center px-4">
            <motion.p
              className="text-gray-600 text-xs sm:text-sm flex items-center text-center"
              whileHover={{ scale: 1.02 }}
              transition={{ duration: 0.3 }}
            >
              &copy; {currentYear} <span className="mx-1 font-medium text-gray-700">FWB+ Event Organizer</span> All rights reserved.
            </motion.p>
