        ...
        >
          ...
          >
            <p className="font-inter text-lg md:text-xl text-gray-600 leading-relaxed">
              Kami menyediakan berbagai layanan <span className="font-semibold text-gray-700">event organizer profesional</span> yang dapat disesuaikan dengan kebutuhan dan anggaran Anda, 
              didukung oleh tim berpengalaman dan <span className="font-semibold text-[#f35e0e]">teknologi terdepan</span>.
            </p>
          </motion.div>
        </motion.div>
                  ...
                  <div className="hidden lg:block relative order-2 lg:order-1">
                    <div className="relative h-[350px] md:h-[450px] lg:h-[500px] w-full rounded-3xl overflow-hidden group">
                      ...
                      <div className="relative h-full w-full overflow-hidden rounded-3xl border border-white/30 shadow-2xl backdrop-blur-sm"
                        style={{ boxShadow: `0 25px 50px -12px ${service.color}20` }}
                      >
                        <Image
                          src={service.image}
                          alt={service.title}
                  ...
                  >
                    ...
                    >
                      <h4 className="font-unbounded text-lg md:text-xl font-bold text-gray-900 flex items-center">
                        <svg className="w-5 h-5 mr-3" style={{ color: service.color }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        Layanan Tersedia
                      </h4>
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
              <div className="lg:max-w-xl text-center lg:text-left">
                ...
                <motion.p 
                  ...
                  transition={{ delay: 1.2, duration: 0.6 }}
                >
                  Konsultasikan kebutuhan acara Anda secara <span className="font-semibold text-blue-200">gratis</span> dengan tim profesional kami dan dapatkan penawaran terbaik.
                </motion.p>
              </div>
